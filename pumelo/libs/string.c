 ...
 * c - character to be located
 *
 * The strfind() function is like strchr() except that if c is  not found in s, 
 ...
 * a pointer to the first character following the integer representation in s is stored 
 * in the object pointed by endptr.
 *
